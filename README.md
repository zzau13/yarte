...
- Integrated, zero copy and infallible, simd json serializer to [`Bytes`](https://github.com/tokio-rs/bytes)
- Infallible render to [`Bytes`](https://github.com/tokio-rs/bytes)
