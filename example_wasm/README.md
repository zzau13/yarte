            ...
            if __dom_len__ < __data_len__ {
                for __key___0x00000000 in ((&(self.fortunes)).into_iter()).skip(__dom_len__) {
                    self.black_box.__ytable__1.push({
                        ...
                        let __ynode__3 = __ynode__2
                            .next_element_sibling()
                            .unwrap_throw()
                            .next_element_sibling()
                            .unwrap_throw();
                        __ynode__1.set_text_content(Some(&format!("{}", __key___0x00000000.id)));
                        __ynode__2.set_text_content(Some(&format!("{} {}", self.head, __key___0x00000000.message)));
                        __ynode__3.set_text_content(Some(&format!("{} {}", self.head, __key___0x00000000.message)));
        ...
        Self {
            ...
            black_box: TestBlackBox {
                ...
                component_1: {
                    ...
                    let __n__5 = doc.create_element("td").unwrap_throw();
                    __n__0.append_child(&__n__5).unwrap_throw();
                    __n__5.set_attribute("class", "col-msg").unwrap_throw();
                    let __n__6 = doc.create_element("td").unwrap_throw();
                    __n__0.append_child(&__n__6).unwrap_throw();
                    __n__6.set_attribute("class", "another").unwrap_throw();
                    let __n__7 = doc.create_element("a").unwrap_throw();
                    __n__6.append_child(&__n__7).unwrap_throw();
                    __n__7.set_attribute("class", "button").unwrap_throw();
                    __n__7.set_text_content(Some("Fol"));
                    __n__0
                },
            },
        }
